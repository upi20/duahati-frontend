...
$route['kursi-berhadiah/(:num)'] = 'kursiBerhadiah/index/$1';
$route['mot/(:num)'] = 'mot/index/$1';
$route['tebak-skor/(:num)'] = 'tebakSkor/index/$1';
$route['leardboard/(:num)'] = 'leardBoard/index/$1';
